...
public class UploadFile {
    ...
    public static List<FileInfo> uploadFile(String domain, String clientId, String token, String appId, String suffix) {
        ...
        // File to upload.
        FileBody bin = new FileBody(new File("E:\\app-hms-release.apk"));
...
//            .addTextBody("parseType","1")
        ...
        try {
            ...
            if (statusCode == HttpStatus.SC_OK) {
                ...
                List<FileInfo> fileInfo = fileServerResult.getResult().getUploadFileRsp().getFileInfoList();

                fileInfo.get(0).setFileName("app-hms-release.apk");
